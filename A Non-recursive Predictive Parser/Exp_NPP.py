...
if __name__ == '__main__':
    ...
    T = eval(raw_input(":"))
    # # print(T)
    # # 预测表： [{'id' : ['E', ';' , 'L'] ,       'num' : ['E', ';' , 'L'],      '(' : ['E', ';' , 'L'],     '#' : ['n']} ,{'id' : ['T', 'rE'] ,       'num' : ['T', 'rE'] ,     '(' : ['T', 'rE'] } ,{'+' : ['+' , 'T' ,  'rE'] ,      '-' : ['-' , 'T' ,  'rE'] ,       ')' : ['n'] ,       ';' : ['n'] } ,{'id' : ['F' , 'rT'] ,      'num' : ['F' , 'rT'] ,       '(' : ['F' , 'rT'] } ,{'+' : ['n'] ,      '-' : ['n'] ,     '*' : ['*' , 'F', 'rT'] ,     '/' : ['/' , 'F', 'rT'] ,     'mod' : ['mod' , 'F', 'rT'] ,       ')' : ['n'] ,       ';' : ['n']} ,{'id' : ['id'] ,      'num' : ['num'] ,       '(' : ['(', 'E' , ')'] }  ]
    print( "请输入文法G的预测表M , 输入格式如{'id' : ['id'] ,      'num' : ['num'] ,       '(' : ['(', 'E' , ')'] }  ] ")
    #  "[{'id' : ['E', ';' , 'L'] ,       'num' : ['E', ';' , 'L'],      '(' : ['E', ';' , 'L'],     '#' : ['n']} , \n "
    #  "{'id' : ['T', 'rE'] ,       'num' : ['T', 'rE'] ,     '(' : ['T', 'rE'] } ,  \n "
    #  "{'+' : ['+' , 'T' ,  'rE'] ,      '-' : ['-' , 'T' ,  'rE'] ,       ')' : ['n'] ,       ';' : ['n'] } ,  \n "
    #  "{'id' : ['F' , 'rT'] ,      'num' : ['F' , 'rT'] ,       '(' : ['F' , 'rT'] } ,   \n"
    #  "{'+' : ['n'] ,      '-' : ['n'] ,     '*' : ['*' , 'F', 'rT'] ,     '/' : ['/' , 'F', 'rT'] ,     'mod' : ['mod' , 'F', 'rT'] ,       ')' : ['n'] ,       ';' : ['n']} ,   \n"
    #  "{'id' : ['id'] ,      'num' : ['num'] ,       '(' : ['(', 'E' , ')'] }  ] ")
    M = eval(input(":"))
